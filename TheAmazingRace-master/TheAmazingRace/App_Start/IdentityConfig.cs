...
namespace TheAmazingRace
{
    ...
    public class ApplicationUserManager : UserManager<User>
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<User>(context.Get<TheAmazingRaceDbContext>()));
    ...
    public class ApplicationSignInManager : SignInManager<User, string>
    {
        ...
        public static async Task<ClaimsIdentity> GenerateUserIdentityAsync(User user, UserManager<User> manager)
        {
            ...
            if (roles.Count > 0)
            {
                userIdentity.AddClaim(new Claim(CustomClaimTypes.MasterRoleName, roles[0]));
            }
        ...
        {
            return GenerateUserIdentityAsync(user, (ApplicationUserManager)UserManager);
        }
